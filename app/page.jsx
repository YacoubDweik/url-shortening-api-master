...
export default function Home() {
  return (
    <main className="main">
      <h1 className="sr-only">Shortly is a web app for making URLs shorter.</h1>
      <section className="hero">
        <div className="container">
          <div className="hero-image-wrapper">
            <img className="hero-image" src="/assets/illustration-working.svg" alt="" />
          </div>
        ...
        <div className="container">
          ...
          <div className="app-body">
            <div className="body-intro">
              <h2 className="body-title">Advanced Statistics</h2>
              <p className="body-text">
                Track how your links are performing across the web with our advanced statistics dashboard.
              </p>
            </div>
            <div className="body-cards-wrapper">
